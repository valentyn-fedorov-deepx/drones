...
class StaticObstacleDetector:
    ...
    """
    Static obstacle detection with GroundingDINO+SAM, very slow
    ...
    def __init__(self, config_dir, model_dir, imsize):
        ...
        self.grounding_dino = load_model("GroundingDINO/groundingdino/config/GroundingDINO_SwinT_OGC.py", "GroundingDINO/weights/groundingdino_swint_ogc.pth")
    ...
    def process(self, image):
        ...
        for mask, box, conf, phrase in detections:
            obstacles.append(DetectedObject(mask, phrase, conf, (self.H, self.W),
                                            bbox=box))
