...
reconstr_path = Path("/nvme0n1-disk/volodymyr.danylov/vggt")
reconstr_stream_path = Path("/nvme0n1-disk/volodymyr.danylov/StreamVGGT")
src_stream = Path("/nvme0n1-disk/volodymyr.danylov/StreamVGGT/src")
dx_vyzai_path = cur_dir.parent.parent
segment_path = Path("/nvme0n1-disk/volodymyr.danylov/sam2")
code_path = cur_dir/"code"

# adding some paths to sys.path
for p in [reconstr_path, reconstr_stream_path, src_stream, dx_vyzai_path, segment_path, code_path]:
    sys.path.append(str(p))
    
# libs import
from src.data_pixel_tensor import DataPixelTensor
from streamvggt.models.streamvggt_live import StreamVGGT, StreamState, OutsBuffer
